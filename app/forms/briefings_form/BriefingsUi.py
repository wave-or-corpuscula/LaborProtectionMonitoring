...
class Ui_BriefingsWindow(object):
    def setupUi(self, BriefingsWindow):
        ...
        BriefingsWindow.resize(939, 661)
        font = QFont()
        font.setPointSize(9)
        ...
        self.briefings_tw.setGeometry(QRect(10, 370, 911, 211))
        ...
        self.selectedBriefing_le.setGeometry(QRect(420, 280, 191, 41))
        font1 = QFont()
        ...
        self.back_pb.setGeometry(QRect(830, 280, 93, 41))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(20, 280, 111, 41))
        self.label.setFont(font1)
        self.employees_tw = QTableWidget(self.centralwidget)
        self.employees_tw.setObjectName(u"employees_tw")
        self.employees_tw.setGeometry(QRect(10, 40, 911, 231))
        ...
        self.selectedEmployee_le.setGeometry(QRect(130, 280, 161, 41))
        self.selectedEmployee_le.setFont(font1)
        self.label_2 = QLabel(self.centralwidget)
        self.label_2.setObjectName(u"label_2")
        self.label_2.setGeometry(QRect(300, 280, 121, 41))
        self.label_2.setFont(font1)
        self.instruct_pb = QPushButton(self.centralwidget)
        self.instruct_pb.setObjectName(u"instruct_pb")
        self.instruct_pb.setGeometry(QRect(620, 280, 201, 41))
        self.label_3 = QLabel(self.centralwidget)
        self.label_3.setObjectName(u"label_3")
        self.label_3.setGeometry(QRect(10, 0, 121, 41))
        self.label_3.setFont(font1)
        self.label_4 = QLabel(self.centralwidget)
        self.label_4.setObjectName(u"label_4")
        self.label_4.setGeometry(QRect(20, 330, 141, 41))
