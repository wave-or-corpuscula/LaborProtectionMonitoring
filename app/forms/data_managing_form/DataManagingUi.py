...
class Ui_DataManagingWindow(object):
    def setupUi(self, DataManagingWindow):
        ...
        DataManagingWindow.resize(893, 594)
        ...
        self.menubar.setGeometry(QRect(0, 0, 893, 26))
